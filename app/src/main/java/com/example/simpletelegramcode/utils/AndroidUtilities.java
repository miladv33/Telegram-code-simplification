...
//        if (context == null || org.telegram.messenger.AndroidUtilities.statusBarHeight > 0) {
//            return;
//        }
//        int resourceId = context.getResources().getIdentifier("status_bar_height", "dimen", "android");
//        if (resourceId > 0) {
//            org.telegram.messenger.AndroidUtilities.statusBarHeight = context.getResources().getDimensionPixelSize(resourceId);
//        }
//    }
...
//                    roundMessageSize = (int) (org.telegram.messenger.AndroidUtilities.getMinTabletSide() * 0.6f);
//                } else {
//                    roundMessageSize = (int) (Math.min(org.telegram.messenger.AndroidUtilities.displaySize.x, org.telegram.messenger.AndroidUtilities.displaySize.y) * 0.6f);
//                }
...
//        int scale = Math.min(2, (int) Math.ceil(org.telegram.messenger.AndroidUtilities.density));
//        if (provider == -1) {
...
//        if (view == null || Build.VERSION.SDK_INT < 21 || view.getHeight() == org.telegram.messenger.AndroidUtilities.displaySize.y || view.getHeight() == org.telegram.messenger.AndroidUtilities.displaySize.y - statusBarHeight) {
//            return 0;
//        }
//        try {
...
//                spannableStringBuilder.setSpan(new TypefaceSpan(org.telegram.messenger.AndroidUtilities.getTypeface("fonts/rmedium.ttf")), bolds.get(a * 2), bolds.get(a * 2 + 1), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//            }
//            return spannableStringBuilder;
//        } catch (Exception e) {
//            //FileLog.e(e);
...
//        if (dif == 0) dif = v;
//        if (dif < 1000) {
//            return org.telegram.messenger.AndroidUtilities.formatCount(v);
//        }
...
//                return String.format(Locale.ENGLISH, "%s%s", org.telegram.messenger.AndroidUtilities.formatCount((int) num_), numbersSignatureArray[count]);
//            } else {
...
//                                    if (org.telegram.messenger.AndroidUtilities.checkHostForPunycode(address)) {
...
//        pickerBottomLayout.cancelButton.setPadding(org.telegram.messenger.AndroidUtilities.dp(18), 0, org.telegram.messenger.AndroidUtilities.dp(18), 0);
...
//        pickerBottomLayout.doneButton.setPadding(org.telegram.messenger.AndroidUtilities.dp(18), 0, org.telegram.messenger.AndroidUtilities.dp(18), 0);
...
//                    layoutManager.scrollToPositionWithOffset(position, org.telegram.messenger.AndroidUtilities.dp(60));
